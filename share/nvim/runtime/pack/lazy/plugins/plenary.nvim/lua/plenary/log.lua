...
log.new = function(config, standalone)
  ...
  local sep = require("plenary.path"):new(vim.api.nvim_call_function("stdpath", { "cache" }))._sep
  local outfile = string.format("%s%s%s.log", vim.api.nvim_call_function("stdpath", { "cache" }), sep, config.plugin)
